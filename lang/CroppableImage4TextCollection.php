...
class CroppableImage4TextCollection extends WireData {
    ...
    public function __construct() {
        ...
        $globalOptions = CroppableImage4Helpers::arrayToObject(CroppableImage4Helpers::getGlobalConfigSettings(true));
        ...
        $this->textCollection = array(
         ...
         // identify key
            'CroppableImage4TextCollectionVersion' => '0.0.2',

         // FieldtypeCroppableImage4
         ...
         // FieldtypeCroppableImage4ConfAdaptor
            ...
            'fieldsetDescriptionWebp' => $this->_('Here you can define if you want create additional WebP variations.'),
            'caiWebpAdd_Label' => $this->_('Check this to enable creation of additional WebP-Imagefiles.'),
            'caiWebpAdd_Notes' => $this->_('If checked, for every created JPEG and PNG Cropimage, a WebPimage variation is created too.'),
            'caiWebpQuality_Label' => $this->_('Global Setting for WebP Quality'),
            'caiWebpQuality_Description' => $this->_('quality: 1-100 where higher is better but bigger'),
            'caiWebpQuality_Notes' => $this->_(''),
        );
    }
}
